...
func (d *jsiiProxy_DataTerraformRemoteState) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteState) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
