...
func (d *jsiiProxy_DataTerraformRemoteStateLocal) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateLocal) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataTerraformRemoteStateLocal) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
