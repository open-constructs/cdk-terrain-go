...
func (d *jsiiProxy_DataTerraformRemoteStateOss) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateOss) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
