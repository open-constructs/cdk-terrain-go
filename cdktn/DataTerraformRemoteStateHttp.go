...
func (d *jsiiProxy_DataTerraformRemoteStateHttp) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateHttp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
