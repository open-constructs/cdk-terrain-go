...
func (d *jsiiProxy_DataTerraformRemoteStateS3) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateS3) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
