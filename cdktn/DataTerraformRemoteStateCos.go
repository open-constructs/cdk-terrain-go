...
func (d *jsiiProxy_DataTerraformRemoteStateCos) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateCos) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
