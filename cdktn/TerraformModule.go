...
func (t *jsiiProxy_TerraformModule) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (t *jsiiProxy_TerraformModule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
