...
func (c *jsiiProxy_ConsulBackend) GetRemoteStateDataSource(scope constructs.Construct, name *string, fromStack *string) TerraformRemoteState {
...
func (c *jsiiProxy_ConsulBackend) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (c *jsiiProxy_ConsulBackend) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
