...
func (l *jsiiProxy_LocalBackend) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (l *jsiiProxy_LocalBackend) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
