...
func (c *jsiiProxy_CosBackend) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (c *jsiiProxy_CosBackend) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CosBackend) ToHclTerraform() interface{} {
	var returns interface{}
