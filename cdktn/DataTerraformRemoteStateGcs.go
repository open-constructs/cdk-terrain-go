...
func (d *jsiiProxy_DataTerraformRemoteStateGcs) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateGcs) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
