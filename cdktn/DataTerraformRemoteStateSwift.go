...
func (d *jsiiProxy_DataTerraformRemoteStateSwift) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateSwift) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
