...
func (t *jsiiProxy_TerraformElement) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (t *jsiiProxy_TerraformElement) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
