...
func (s *jsiiProxy_StringMapList) InterpolationForAttribute(terraformAttribute *string) IResolvable {
...
func (s *jsiiProxy_StringMapList) Resolve(context IResolveContext) interface{} {
