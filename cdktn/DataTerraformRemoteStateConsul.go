...
func (d *jsiiProxy_DataTerraformRemoteStateConsul) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateConsul) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
