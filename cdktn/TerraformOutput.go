...
func (t *jsiiProxy_TerraformOutput) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (t *jsiiProxy_TerraformOutput) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
