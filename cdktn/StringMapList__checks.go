...
func (s *jsiiProxy_StringMapList) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
...
func (s *jsiiProxy_StringMapList) validateResolveParameters(context IResolveContext) error {
	if context == nil {
