...
func (t *jsiiProxy_TerraformResource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TerraformResource) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (t *jsiiProxy_TerraformResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
