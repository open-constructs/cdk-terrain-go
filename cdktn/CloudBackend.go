...
func (c *jsiiProxy_CloudBackend) GetRemoteStateDataSource(scope constructs.Construct, name *string, fromStack *string) TerraformRemoteState {
...
func (c *jsiiProxy_CloudBackend) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (c *jsiiProxy_CloudBackend) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
