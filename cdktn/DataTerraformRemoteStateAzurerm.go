...
func (d *jsiiProxy_DataTerraformRemoteStateAzurerm) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStateAzurerm) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataTerraformRemoteStateAzurerm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
