...
func (h *jsiiProxy_HttpBackend) GetRemoteStateDataSource(scope constructs.Construct, name *string, fromStack *string) TerraformRemoteState {
	if err := h.validateGetRemoteStateDataSourceParameters(scope, name, fromStack); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HttpBackend) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (h *jsiiProxy_HttpBackend) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
