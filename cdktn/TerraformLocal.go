...
func (t *jsiiProxy_TerraformLocal) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (t *jsiiProxy_TerraformLocal) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
