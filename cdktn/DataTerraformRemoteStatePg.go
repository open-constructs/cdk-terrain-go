...
func (d *jsiiProxy_DataTerraformRemoteStatePg) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (d *jsiiProxy_DataTerraformRemoteStatePg) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
