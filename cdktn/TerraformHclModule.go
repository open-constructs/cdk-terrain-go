...
func (t *jsiiProxy_TerraformHclModule) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (t *jsiiProxy_TerraformHclModule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
