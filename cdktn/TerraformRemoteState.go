...
func (t *jsiiProxy_TerraformRemoteState) RegisterProviderFeatureUsage(feature ProviderFeature) {
...
func (t *jsiiProxy_TerraformRemoteState) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
