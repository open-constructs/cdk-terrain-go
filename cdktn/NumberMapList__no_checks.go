...
func (n *jsiiProxy_NumberMapList) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (n *jsiiProxy_NumberMapList) validateResolveParameters(context IResolveContext) error {
	return nil
}
